...
$email = $password = "";
$email_err = $password_err = $login_msg = "";
    ...
    if (empty($email_err) && empty($password_err)) {
        ...
        if (mysqli_stmt_num_rows($stmt) == 1) {
            ...
            if (mysqli_stmt_fetch($stmt)) {
                ...
                if ($status !== "Approved") {
                    $login_msg = '<div class="alert alert-warning">Your account is pending approval. Please wait for admin approval.</div>';
    ...
    <div class="container mt-5">
        <div class="card mx-auto" style="max-width: 600px;">
            <div class="card-body">
                ...
                <!-- Display login message (approval/pending/errors) -->
                <?php echo $login_msg; ?>
